...
metadata_path='manuscript_metadata_attempted_samples.csv'
pairings={'Region': ['Region','Region_code'], 'District': ['District', 'District_code'], 'HF_lat': ['HF_name', 'Latitude'], 'HF_long': ['HF_name', 'Longitude']}
heirarchies=['Region', 'District', 'HF_name', 'Latitude', 'Longitude']
